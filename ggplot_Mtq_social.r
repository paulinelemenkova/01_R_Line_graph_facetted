...
p2<- ggplot() +
    ...
    geom_line() +
    scale_color_manual(
        values = c("Rural population" = "green4",
                "Urban population" = "deeppink1"),
        labels = c("Rural population", "Urban population")
                        ) +
    scale_x_continuous(n.breaks = 10) +
    theme(
        legend.position = "bottom",
...
ggsave("Fig_Pop_dynamics.jpg", plot = p, dpi = 300,
